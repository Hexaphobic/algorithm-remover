...
(function () {
  ...
  // ponytail: English-UI labels for the non-ad junk units. These render as plain
  // text; "Sponsored" does NOT — Facebook obfuscates it (decoy letters that CSS
  // renders as "Sponsored"), so ads are matched by ad-rendering markup instead.
