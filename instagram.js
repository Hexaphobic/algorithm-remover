...
(function () {
  ...
  // Explore: collapse the media grid but KEEP the in-page search bar. The grid is
  // the highest ancestor of a tile (below <main>) that doesn't contain the search
  // input; the search bar sits in a sibling block and stays usable.
